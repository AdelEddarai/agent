...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_DISABLE_REALTIME:          z.boolean().optional(),                 // Disable realtime collaborative features
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_DISABLE_REALTIME: process.env.NEXT_PUBLIC_DISABLE_REALTIME,
